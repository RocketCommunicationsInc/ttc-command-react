...
const Investigate = ({toggleInvestigate, showInvestigate, contact}: PropTypes) => {
    const [childSubsystem, setChildSubsystem] = useState<string>(contact.subsystems[0].childSubsystems[0].name)
